...
regex = (
    (
        re.compile(r"https?://www\.((hive\.pt)|(hiveinc\.co))"),
        "http://ams-logic-1.bemisc.com:8001",
    ),
    (
        re.compile(r"https?://blog\.((hive\.pt)|(hiveinc\.co))"),
        "http://tutum-hive-legacy.bemisc.com:8022/mvc/hive_blog",
    ),
    (
        re.compile(r"https?://openid\.((hive\.pt)|(hiveinc\.co))"),
        "http://tutum-hive-legacy.bemisc.com:8022/mvc/hive_openid",
    ),
    (
        re.compile(r"https?://([a-zA-Z_-]+)\.((hive\.pt)|(hiveinc\.co))/static"),
        "http://tutum-proyectos.bemisc.com:8012",
    ),
    (
        re.compile(r"https?://([a-zA-Z_-]+)\.((hive\.pt)|(hiveinc\.co))/appier"),
        "http://tutum-proyectos.bemisc.com:8012",
    ),
    (
        re.compile(r"https?://([a-zA-Z_-]+)\.((hive\.pt)|(hiveinc\.co))/render"),
        "http://tutum-proyectos.bemisc.com:8012",
    ),
    (
        re.compile(r"https?://([a-zA-Z_-]+)\.((hive\.pt)|(hiveinc\.co))"),
        "http://tutum-proyectos.bemisc.com:8012/render/{0}",
    ),
)
